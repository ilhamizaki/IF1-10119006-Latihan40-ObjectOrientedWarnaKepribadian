 ...
 * Kelas    : IF 1
 * NIM      : 10119006
 * Deskripsi Program : class menentukan kepribadian
 */
public class Kepribadian {
    public final String kepribadianMerah = "1. Periang,\n" +
                                "2. Pemberani,\n" +
    ...
    public final String kepribadianBiru = "1. Menyenangkan,\n" +
                                "2. Bijaksana,\n" +
    ...
    public final String KepribadianKuning = "1. Optimis,\n" +
                                "2. Suka bergaul,\n" +
                                "3. Periang,\n" +
                                "4. Senang menolong,\n" +
                                "5. Lincah dan aktif,\n" +
    ...
    public final String kepribadianUngu = "1. Optimis,\n" +
                                "2. Tidak pernah ragu,\n" +
    ...
    public final String kepribadianHijau =  "1. Romantis,\n" +
